Feature: Raise ModelComparisonCompletedEvent when model comparison is successfully performed
  ...
  Background:
    Given I have imported the ModelCriticism class from the pyro_thunder.model_criticism module
    And I have imported the ModelComparisonCompletedEvent class from the pyro_thunder.model_criticism.events module
